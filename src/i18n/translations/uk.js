export const uk = {
  translation: {
    ...
    validation: {
      ...
      valid_email: 'Електронна адреса некоректна',
      ...
      password_min: 'Пароль повинен містити мінімум 6 символів',
      password_max: 'Пароль не може перевищувати 30 символів',
      password_required: "Пароль є обов'язковим",
      password_match: 'Паролі повинні співпадати',
      valid_time: 'Час повинен бути у форматі HH:mm (00:00 - 23:59)',
      ...
      number_max: "Об'єм води не може перевищувати 1500 мл",
    ...
    notifications: {
      ...
      welcome_login: 'Вітаю, {{userEmail}}!',
      logout_successful: 'Вихід виконано успішно!',
      ...
      water_updated: 'Запис про воду успішно оновлено!',
      ...
      get_data_day: 'Дані про споживання води успішно отримано!',
    ...
    trackerPage: {
      ...
      liters: '{{value}} Л',
      waterList_placeholder_title: 'Ваш список порожній',
      waterList_placeholder_text:
        'Гідратація важлива! Додайте свій перший запис і залишайтеся здоровими.',
    },
    settingModal: {
    ...
    errors: {
      ...
      err_401: 'Неавторизовано. Невірний пароль.',
      ...
      unable_currentUser: 'Не вдалося отримати поточного користувача',
      ...
      avatar: 'Не вдалося оновити аватар',
    },
    waterList: {
